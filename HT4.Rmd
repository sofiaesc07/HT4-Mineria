...
test1<-datos[-corte,]
datos <- datos %>% mutate_at(c('SaleCondition','SaleType','MiscFeature','Fence','PoolQC','PavedDrive','GarageCond','GarageQual','GarageFinish','FireplaceQu','Functional','KitchenQual','Electrical','CentralAir','HeatingQC','Heating','BsmtFinType2','BsmtFinType1','BsmtExposure','BsmtCond','BsmtQual','Foundation','ExterCond','LotShape','LandContour','Utilities','LotConfig','Neighborhood','Condition1','Condition2'), as.factor)
```
...
Predijo el resultado con un error del 2% lo cuál no es malo pero puede mejorar, y lo hizo con una longitud de 4 por lo que debería de intentar con mayor longitud para ver si la prección mejora y cambia. 
...
confusionMatrix(test1[, 81], pred2)
